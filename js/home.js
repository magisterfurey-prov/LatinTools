...
const tagged = BOOK.id === 1 ? 'person, tense' : 'person, tense, mood';
set('translateTileText', `Tag case, number, gender, ${tagged}, agreement, and syntactic role for ${sentences.length} practice sentences.`);
