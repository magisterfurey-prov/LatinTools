...
A free, static practice site for *Latin for the New Millennium*, Level 1 (Chapters 1–21): vocabulary flashcards, grammar charts, and sentence analysis. No backend, no build step, no dependencies — just HTML/CSS/JS, so it runs directly on GitHub Pages.
